...
- `autogenerated` (Boolean) Whether this target was auto-detected by the collector.
- `consecutive_failure_count` (Number) Number of consecutive scrape failures for this target.
- `container` (String) Container the target was detected in, if any.
- `created_at` (String) The time when this target was created.
- `detected_host` (String) Host the target was detected on, if any.
- `id` (String) The ID of this target.
- `last_ping_at` (String) Last time the target was successfully scraped.
- `paused_until` (String) If set, the target is in backoff until this time.
