...
func TestResourceErrorsApplicationGroup(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		prefix := "/api/v1/application-groups"
		id := "1"
	...
	var name = "Test Errors Application Group"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Step 3 - destroy.
			{
				ResourceName:      "logtail_errors_application_group.this",
				ImportState:       true,
